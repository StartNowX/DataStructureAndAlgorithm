...
/**
 * 构造自动机，参考官方解读https://leetcode-cn.com/problems/string-to-integer-atoi/solution/zi-fu-chuan-zhuan-huan-zheng-shu-atoi-by-leetcode-/
 */
class Automaton {
   private:
    string state = "start";
...
class Solution {
   public:
    ...
    // 只能涵盖最简单的例子，如“42”，“-42”等，如果需要涵盖所有情况，代码会比较冗余
    int myAtoi(string str) {
        if (str.length() == 0) {
            return 0;
        }
